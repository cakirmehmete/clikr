...
class AllLecturesFrame extends React.Component {
    ...
    constructor(props) {
        ...
        this.parentCourse = this.profStore.courses[this.profStore.course_id]
    }
                    ...
                    <CardContent>
                        ...
                        <List component="nav">
                            {this.profStore.lectures.map((lectureObj, index) => {
                                return (
                                    <ListItem divider button key={index} onClick={this.handleLectureClick(index)} >
                                        <ListItemText primary={lectureObj.title} />
                                    </ListItem>
                                )
                            })}
                        </List>
